...
public class DialView extends View {
    ...
    private void init(){
        ...
        mDialPoint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDialPoint.setColor(Color.GRAY);
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mActiveSelection >= 1){
                    mDialPoint.setColor(Color.GREEN);
                }
                else {
                    mDialPoint.setColor(Color.GRAY);
                }
    ...
    protected void onDraw(Canvas canvas){
        super.onDraw(canvas);
        canvas.drawCircle(mWidth/2, mHeight/2, mRadius, mDialPoint);
